...
const float ZERO_CURRENT_VOLTAGE = 2.46; 
const float SENSOR_SENSITIVITY = inputVoltage/105; // volts / A must be somewhere between 66 and 185 according to datasheet
...
float t1 = 0;
float t2 = 0;
float distance = 1; // change to distance between buckets later
...
void readHallEffect() {
  ...
  float pulse_time = t2-t1;

  Serial.print("Hall Effect Belt Speed: ");
  Serial.print(distance/pulse_time)
  t1 = t2;
...
const int TEMP_SENSITIVITY = 100; // volts per degree C
...
// ====== H-BRIDGE PINS ======
const int motorIn1 = 8;   // IN1
const int motorIn2 = 10;   // IN2
const int motorPWM = 11;    // ENA / PWM pin
